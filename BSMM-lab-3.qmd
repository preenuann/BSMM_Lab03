...
{r} 
#Finding the median measure across cocktail recipes
...
{r}
# Filling all the missing values with 0 after pivoting the table
...
# Finding gin content in the cocktail 'Leap Frog Highball'
...
{r}
#Steps to normalize the predictors
...
{r}
# Finding the most used ingredient
...
PC1 and PC2 have negative values for light cocktail classics, which means PC1 and PC2 are not focused on cocktail classics. Drinks under these categories will less likely be cordials/liqeurs or light cocktail classics. 

PC1 focuses on unmixed heavy alcohol and less cocktails. 

PC2 includes cocktail oriented drinks and less straightup alcohol. It will still contain moderate level of alcohol.
